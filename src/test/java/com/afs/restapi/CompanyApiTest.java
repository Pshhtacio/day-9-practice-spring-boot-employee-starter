...
class CompanyApiTest {
    ...
    void should_create_employee() throws Exception {
        Company newCompany = companyRepository.save(getCompany1());
    ...
    void should_find_companies() throws Exception {
        Company existingCompany = companyRepository.save(getCompany1());
    ...
    void should_find_companies_by_page() throws Exception {
        Company company1 = companyRepository.save(getCompany1());
        Company company2 = companyRepository.save(getCompany2());
